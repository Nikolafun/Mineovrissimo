 ...
 *
 */
package net.mcreator.bebraroflpov;
...
import net.mcreator.bebraroflpov.init.BebraRoflPovModBiomes;
...
@Mod("bebra_rofl_pov")
public class BebraRoflPovMod {
	public static final Logger LOGGER = LogManager.getLogger(BebraRoflPovMod.class);
	public static final String MODID = "bebra_rofl_pov";

	public BebraRoflPovMod() {
		MinecraftForge.EVENT_BUS.register(this);
		BebraRoflPovModTabs.load();
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		BebraRoflPovModSounds.REGISTRY.register(bus);
		BebraRoflPovModBlocks.REGISTRY.register(bus);
		BebraRoflPovModItems.REGISTRY.register(bus);
