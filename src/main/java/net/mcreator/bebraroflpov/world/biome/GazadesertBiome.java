...
public class GazadesertBiome {
	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(-16724788).waterColor(-10066432).waterFogColor(329011).skyColor(-16724788).foliageColorOverride(-13421773).grassColorOverride(9470285).build();
