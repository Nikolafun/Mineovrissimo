...
package net.mcreator.bebraroflpov.world.biome;
...
public class GazadesertBiome {
	...
	public static Biome createBiome() {
		BiomeSpecialEffects effects = new BiomeSpecialEffects.Builder().fogColor(-13434829).waterColor(-10066432).waterFogColor(329011).skyColor(-13434829).foliageColorOverride(-13421773).grassColorOverride(9470285).build();
		BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder();
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("bebra_rofl_pov:tree_gazadesert",
						FeatureUtils.register("bebra_rofl_pov:tree_gazadesert", Feature.TREE,
