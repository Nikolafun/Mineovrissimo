...
public class AdolfHitlerEntity extends Monster {
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		AdolfHitlerOnInitialEntitySpawnProcedure.execute(world, this);
		return retval;
	}

	public static void init() {
		SpawnPlacements.register(BebraRoflPovModEntities.ADOLF_HITLER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
