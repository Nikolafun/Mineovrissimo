...
public class EvreeszigatoradolfEntity extends AbstractArrow implements ItemSupplier {
	public EvreeszigatoradolfEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(BebraRoflPovModEntities.EVREESZIGATORADOLF.get(), world);
	}

	public EvreeszigatoradolfEntity(EntityType<? extends EvreeszigatoradolfEntity> type, Level world) {
		super(type, world);
	}

	public EvreeszigatoradolfEntity(EntityType<? extends EvreeszigatoradolfEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public EvreeszigatoradolfEntity(EntityType<? extends EvreeszigatoradolfEntity> type, LivingEntity entity, Level world) {
	...
	public static EvreeszigatoradolfEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		EvreeszigatoradolfEntity entityarrow = new EvreeszigatoradolfEntity(BebraRoflPovModEntities.EVREESZIGATORADOLF.get(), entity, world);
	...
	public static EvreeszigatoradolfEntity shoot(LivingEntity entity, LivingEntity target) {
		EvreeszigatoradolfEntity entityarrow = new EvreeszigatoradolfEntity(BebraRoflPovModEntities.EVREESZIGATORADOLF.get(), entity, entity.level);
